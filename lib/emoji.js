...
;(function() {
	 ...
	 */
	emoji.prototype.replace_unified_with_colons = function(str){
		var self = this;
		self.init_unified();
	 ...
	 * replaced by their colon string representations (ie. `:smile:`)
	 */
	emoji.prototype.toColons = function(str){
		var self = this;
		str = self.replace_emoticons_with_colons(str);
		str = self.replace_unified_with_colons(str);
	 ...
	 */
	emoji.prototype.toUnicode = function(str){
		var self = this;
		self.init_colons();
		...
		return str.replace(self.rx_colons, function(m){
			...
			if (idx.indexOf('::skin-tone-') > -1){
				...
				if (val){
					if(val) val = self.data[val];
					return val ? val[0][0] : m;
				}
				
				else {
					if(skin_val) val = self.data[skin_val];
					return val ? val[0][0] : m;
				}
			}
